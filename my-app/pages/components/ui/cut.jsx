  ...
  return (
    <div className="bg-[#efecec] p-8 rounded-lg">
      ...
      <div className="mb-[10px] ">
        ...
        <input
          type="date"
          className="border-[1px] rounded-md border-black w-[370px] sm:w-[400px] h-[30px]"
          onChange={(e) => {
            handleDate(e);
          }}
        />
      ...
      <div className=" mb-[10px]">
        ...
        >
          <SelectTrigger className="w-[370px] sm:w-[400px] h-[30px] bg-white">
      ...
      <div className=" mb-[10px]">
        ...
        >
          <SelectTrigger className="bg-white w-[370px] sm:w-[400px] h-[30px]">
            <SelectValue placeholder="Value" />
          </SelectTrigger>
          <SelectContent className="bg-white">
      ...
      <div className=" mb-[10px]">
        ...
        <Input
          className="w-[370px] sm:w-[400px] h-[30px] rounded-sm bg-white"
      ...
      <div className=" mb-[10px]">
        ...
        <Input
          className="w-[370px] sm:w-[400px] h-[30px] bg-white"
          placeholder="Value"
