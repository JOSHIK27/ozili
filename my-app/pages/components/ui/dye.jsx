...
export default function Dye({ dyeType, dyeStyle, dyer, fabric }) {
  ...
  return (
    <div>
      <Nav />
      <div className="flex mb-16 mt-16 ml-[32px] mt-4 justify-center">
        <img
          width="30"
          height="15"
      ...
      <div className="flex sm: flex sm:justify-evenly flex-wrap mb-[60px]">
        <div className="flex mb-[10px] ml-4">
          <h1 className="mr-4 text-sm">Dye Date</h1>
          <input
            type="date"
            className="bg-[#FFF4ED] border-[1px] border-black w-[150px] h-[16px]"
          />
        </div>
        <div className="flex">
          <h1 className="text-sm sm: mr-4">Transaction</h1>
          <Select>
            <SelectTrigger className="w-[150px] h-[8px]">
              <SelectValue placeholder="Value" />
            </SelectTrigger>
            <SelectContent className="bg-white">
              <SelectItem value={"type1"}>regular</SelectItem>
              <SelectItem value={"type2"}>adjustment</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div className="flex">
      ...
      <div className="flex justify-evenly">
        ...
        <Button
          ...
          className="border-[2px] h-[7px] border-neutral-400"
        >
          SUBMIT
        </Button>
      </div>
