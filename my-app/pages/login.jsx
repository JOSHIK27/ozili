import { Divider, TextInput, Card } from "@tremor/react";
      ...
      <div className="flex justify-center mt-12">
        <div className="bg-white shadow-lg rounded-lg p-8">
          <div className="w-[345px] sm:w-[400px] ">
            <h3 className="text-center text-tremor-title  text-green-700 font-semibold">
              Log in
            </h3>
            <form action="#" method="post" className="mt-6">
              ...
              <button
                type="submit"
                className="mt-4 w-full whitespace-nowrap rounded-tremor-default bg-green-700 py-2 text-center text-tremor-default font-medium text-tremor-brand-inverted shadow-tremor-input hover:bg-green-800 dark:bg-dark-tremor-brand dark:text-dark-tremor-brand-inverted dark:shadow-dark-tremor-input dark:hover:bg-dark-tremor-brand-emphasis"
              >
                Sign in
              </button>
            </form>
